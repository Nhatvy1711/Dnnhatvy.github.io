...
<head>
    ...
    <style>
        * {
        ...
        /* EXERCISE 6.3: Error message styles */
        .error {
            color: red;
            font-size: 14px;
            display: block;
    ...
    <div class="container">
        ...
        <form action="student" method="POST">
            ...
            <div class="form-group">
                ...
                <!-- EXERCISE 6.3: Error message for student code -->
            ...
            <div class="form-group">
                ...
                <!-- EXERCISE 6.3: Error message for full name -->
            ...
            <div class="form-group">
                ...
                <!-- EXERCISE 6.3: Error message for email -->
            ...
            <div class="form-group">
                ...
                <!-- EXERCISE 6.3: Error message for major -->
